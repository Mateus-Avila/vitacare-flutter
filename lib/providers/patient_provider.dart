  ...
  PatientProvider()
      : _patients = [
          Patient(
            ...
            name: 'Maria da Silva',
            age: 74,
            chronicCondition: 'Hipertensao arterial',
            caregiver: 'Ana Silva',
            phone: '(11) 91234-5566',
          ...
          Patient(
            ...
            name: 'Helena Santos',
            age: 81,
            chronicCondition: 'Insuficiencia cardiaca',
        ...
        _records = [
          HealthRecord(
            ...
            diastolic: 86,
            glucose: 122,
            notes: 'Paciente bem disposta e sem dor.',
          ),
          HealthRecord(
            id: 'R002',
            patientId: 'P002',
            ...
            diastolic: 92,
            glucose: 178,
            notes: 'Ajustar orientacao alimentar e monitorar.',
          ),
          HealthRecord(
            id: 'R003',
            patientId: 'P003',
            ...
            diastolic: 102,
            glucose: 214,
            notes: 'Prioridade alta. Reavaliar equipe medica.',
          ),
        ];
